...
def main():
    ...
    #############################################
    # get input and vallidate values for a pet. #
    #############################################
    ...
    while True:
        ...
        # validate input. 
            ...
            print("Pet age must be a positive integer.\n")
            #continue    
        if input_age < 1:
             print("Pet age must be greater than 0.")        
        elif input_age > 0:
            break   
        else:
             break
    ...
    ################################################
    # set Animal's properties to the input values. #
    ################################################ 
